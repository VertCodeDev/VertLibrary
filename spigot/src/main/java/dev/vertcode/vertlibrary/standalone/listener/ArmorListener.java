...
import dev.vertcode.vertlibrary.event.ArmorEquipEvent;
import dev.vertcode.vertlibrary.event.enm.ArmorType;
import dev.vertcode.vertlibrary.nbt.Version;
...
public class ArmorListener implements Listener {
    ...
    private final Plugin plugin = VertLibrary.getInstance();
...
//			}
            ...
            if (e.getClickedBlock() != null && e.getAction().equals(Action.RIGHT_CLICK_BLOCK)) {// Having both of these checks is useless, might as well do it though.
